...
base_dir = "/home/ppa/xinting/PPA4LLMs/runs/softmax_wrapper/1_softmax_wrapper_opt"  

# Define the output CSV file path
output_csv_path = "/home/ppa/xinting/PPA4LLMs/arch_explore/ppa_softmax_wrapper_extracted_data.csv"

# Column headers for CSV
csv_columns = [
    "Trial Number", "Suggestion Number", "Clock Period (ns) Entered", "Clock_Min_Period", "Clock Slack (ns)", 
    "Clock_Worst_Slack","softmax_choice", "max_context_length", "Total Period (ns)", "ABC Max Fanout", 
            ...
            if os.path.isdir(folder_path) and os.path.exists(ppa_json_path):
                try:
                    ...
                    data = {
                        ...
                        "softmax_choice": ppa_data["hyperparameters"]["softmax_choice"],
                        "max_context_length": ppa_data["hyperparameters"]["max_context_length"],
