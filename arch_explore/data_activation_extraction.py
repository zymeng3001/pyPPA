...
base_dir = "/home/ppa/xinting/PPA4LLMs/runs/activation/1_activation_opt"  

# Define the output CSV file path
output_csv_path = "/home/ppa/xinting/PPA4LLMs/arch_explore/ppa_activation_extracted_data.csv"

# Column headers for CSV
csv_columns = [
    "Trial Number", "Suggestion Number", "Clock Period (ns) Entered", "Clock_Min_Period", "Clock Slack (ns)", 
    "Clock_Worst_Slack","Head_dim", "activation", "Total Period (ns)", "ABC Max Fanout", 
            ...
            if os.path.isdir(folder_path) and os.path.exists(ppa_json_path):
                try:
                    ...
                    data = {
                        ...
                        "Head_dim": ppa_data["hyperparameters"]["head_dim"],
                        "activation": ppa_data["hyperparameters"]["activation"],
