...
problem.search_space.root.add_discrete_param(name='gbus_width', feasible_values=np.arange(16,272,16).tolist(), default_value=16)
...
study_client = clients.Study.from_study_config(
  study_config,
  owner='ppa_runner',
  study_id='ppa_core_array_opt_fix_max_context_length'
)
