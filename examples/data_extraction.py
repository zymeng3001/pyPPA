...
output_csv_path = "/home/ppa/xinting/PPA4LLMs/ppa_extracted_data.csv"

# Column headers for CSV
csv_columns = [
    "Trial Number", "Suggestion Number", "Clock Period (ns) Entered", "Clock_Min_Period", "Clock Slack (ns)", 
    "Clock_Worst_Slack", "Number of Heads", "Number of Columns", "Max Context Length", "Gbus width", "Total Period (ns)", "ABC Max Fanout", 
    "ABC Map Effort", "Power (W)", "Area (um^2)", "Total Cells", "Sequential Cells", 
            ...
            if os.path.isdir(folder_path) and os.path.exists(ppa_json_path):
                try:
                    ...
                    data = {
                        ...
                        "Number of Heads": ppa_data["hyperparameters"]["n_heads"],
                        "Number of Columns": ppa_data["hyperparameters"]["n_cols"],
                        "Max Context Length": ppa_data["hyperparameters"]["max_context_length"],
                        "Gbus width": ppa_data["hyperparameters"]["gbus_width"],
