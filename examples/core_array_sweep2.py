...
problem.search_space.root.add_int_param(name='n_heads', min_value=1, max_value=16, default_value=2) 
problem.search_space.root.add_int_param(name='n_cols', min_value=1, max_value=16, default_value=2) 
...
study_client = clients.Study.from_study_config(
  study_config,
  owner='ppa_runner',
  study_id='ppa_core_array_opt_hier'
)
...
def is_feasible(suggestion) -> bool:
	...
	if n_cols*n_heads > 50 or n_heads > 6:
